---
title: 延时任务一锅端
description: 延时任务的需求是非常常见的，在我们的开发生涯中，我相信大部分研发人员是会有接触到这一块的。其中，我们在现实生活中比较常接触到的场景有 - 下单后未付款通知 - 订单延迟生成短信通知 - 红包未领取退款通知 - 用户行程将近通知 - 微信公众号的文章延时发布推送等 - 存储 主要负责存储任务的相关信息...
date: 2020-09-14
tags:
  - id: "netty"
    title: "Netty"
...
![Leader-follower 线程模型](/posts/figure-out-delay-task/leader_follower.png)
...
![简易时间轮](/posts/figure-out-delay-task/time_round_1.png)
...
> (eg. tickDuration=1ms, interval=1d -> wheelSize = 1000 _ 60 _ 60 \* 24 = 86400000)，如何解决？

#### 含轮次的时间轮

![多轮次时间轮](/posts/figure-out-delay-task/time_round_2.png)
...
![层级时间轮](/posts/figure-out-delay-task/time_round_3.png)
...
![QMQ 整体架构](/posts/figure-out-delay-task/qmq_arch.png)
...
![QMQ 延迟消息实现](/posts/figure-out-delay-task/qmq_delay.png)
...
![QMQ 延迟消息流程](/posts/figure-out-delay-task/qmq_delay_fllow.png)
