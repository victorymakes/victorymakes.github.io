...
![Diagram 1: Message Channel between the parent and the child workers](/posts/nodejs-worker-threads-deep-dive/message_channel.png)
...
![Diagram 2: Worker Implementation Internals](/posts/nodejs-worker-threads-deep-dive/worker_internals.png)
...
![How efficient is it to use worker_threads](/posts/nodejs-worker-threads-deep-dive/worker_threads_efficient.png)
