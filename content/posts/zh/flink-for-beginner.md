---
title: Flink 入门教程
description: 大数据是近些年才出现的吗，人们是近些年才发现大数据的利用价值的吗？其实不然，早在几十年前，数学分析就已经涉猎金融行业了，人们依托于金融和数学知识来建立数学模型，利用金融市场所产的数据来预测金融市场产品收益同风险波动的关系。 到如今，互联网也发展了好些年了，越来越多的数据产生(用户浏览数据、搜索记录、...
date: 2019-06-08
tags:
  - id: "flink"
    title: "Flink"
...
![lambda架构](/posts/flink-for-beginner/lambda.png)
...
结合框架后，一个可能的架构:
![lambda架构示例](/posts/flink-for-beginner/lambda-example.png)
...
![kappa架构](/posts/flink-for-beginner/kappa.png)
...
![Flink、Spark和Storm对比](/posts/flink-for-beginner/flink-compare.png)
可见，Flink不管是在 Lambda 架构还是 Kappa 架构中都能占有一席之地，特别是在Kappa 架构中，我觉得使用Flink是个不错的选择，下面让我们一起来入门Flink框架.

### Flink简介

![Flink处理流程](/posts/flink-for-beginner/flink-process.png)
...
![Flink基本架构](/posts/flink-for-beginner/flink-art.png)
...
3. 进入web页面查看集群的任务情况(由于刚刚改了端口，所以应该是访问 http://localhost:9091/)
   ...
   ```
   ![Flink后台监控页面](/posts/flink-for-beginner/flink-back.png)
...
![Flink编程模型](/posts/flink-for-beginner/dataflow.png)
...
**滚动窗口**:
![滚动窗口图解](/posts/flink-for-beginner/window-scroll.png)
RT，定义一个一分钟的滚动窗口:
...
**滑动窗口**:
![滑动窗口图解](/posts/flink-for-beginner/window-flip.png)
...
![watermark](/posts/flink-for-beginner/watermark.png)
...
![有状态处理和无状态处理的差别](/posts/flink-for-beginner/flink-state.png)
