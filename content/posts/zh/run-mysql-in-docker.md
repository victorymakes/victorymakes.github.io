...
description: CentOS 7.3 64bit 1. 移除旧版本Docker > yum remove docker docker-common docker-selinux docker-engine 2. 设置Docker仓库 2.1 安装所需要的包 > yum install -y yum-utils...
date: 2017-07-26
tags:
  - id: "docker"
    title: "Docker"
