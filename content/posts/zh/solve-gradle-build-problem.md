...
description: 一次项目更新后，发现项目无法正常 build 了，出现如下报错： 1. Review 代码更新，寻找可疑点 这一步 review 没有发现什么特殊的改动，只是更改了几个 proto 文件的定义。但是回退代码后却又能正常 build，所以说明构建失败的确是此次更新引入的问题。 2. 根据报错信息寻找问...
date: 2019-08-24
tags:
  - id: "gradle"
    title: "Gradle"
