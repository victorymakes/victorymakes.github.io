---
title: Java 多线程
description: 本次本章从线程的基础讲到线程的相关实现类，每个章节算是一小块知识点，在每个知识点中，穿插地讲对应的知识原理，以及对应的常见面试题及其解答。多数面试题是前后环环相扣的。 线程是操作系统能够进行运算调度的最小单位。它被包含在进程之中，是进程中的实际运作单位。一条线程指的是进程中一个单一顺序的控制流，一个...
date: 2020-07-23
tags:
  - id: "threads"
    title: "Threads"
...
![线程生命周期](/posts/java-threads/threads.png)
