...
description: 写代码久了，一直在用别人提供的第三方包依赖，有时是不是也会想着有一天别人能够使用自己的开源出去的项目。让我们从最简单的开始，提取一个小项目，将其开源并发布到中央仓库让大伙可以直接通过配置 Maven 依赖来使用。 我相信应该是有不少人都有过开源并发布自己项目的想法的，但是其中最大的一个问题可能就是不...
date: 2020-07-23
tags:
  - id: "java"
    title: "Java"
...
![Github repo tags](/posts/how-to-publish-to-maven/set-tags.png)
...
![创建 Jira 工单-1](/posts/how-to-publish-to-maven/create-jira-1.png)
![创建 Jira 工单-2](/posts/how-to-publish-to-maven/create-jira-2.png)
...
![生成秘钥](/posts/how-to-publish-to-maven/create-secret.png)
