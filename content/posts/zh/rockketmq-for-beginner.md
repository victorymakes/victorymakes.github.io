---
title: RocketMQ 概览
description: Apache RocketMQ 是阿里开源的一款高性能、高吞吐量的分布式消息中间件。相比于 Kafka，其拥有更好的实时性和消息可靠性。更适用于和 Money 相关的系统。它支持如下特性： - 订阅/发布模式的消息 > 支持消费组模式的消费，即一个消费组集群内只有一个实例会收到那一条消息。 - 延时...
date: 2019-11-18
tags:
  - id: "rocketmq"
    title: "RocketMQ"
...
![RocketMQ 物理架构](/posts/rockketmq-for-beginner/RocketMQ_A.png)
...
2. 调用 `MQClientInstance` 的 start 方法
   ...
   - 启动拉取消息的线程服务
   - 启动 reblance 的线程服务
3. 向所有 Broker 发送心跳信息 并上传对应的 Filter class 信息
...
![RocketMQ 事务消息](/posts/rockketmq-for-beginner/RocketMQ_T.png)
...
![RocketMQ Broker Module](/posts/rockketmq-for-beginner/RocketMQ_B.png)
...
![RocketMQ Message](/posts/rockketmq-for-beginner/RocketMQ_M.png)
