---
title: Feign基础教程
description: "Feign使得 客户端编写更方便。 灵感来源于Retrofit、JAXRS-2.0和WebSocket。 最初是为了降低统一绑定Denominator 到 的复杂度，不区分是否支持 。 Maven依赖: --- 你可以使用 和 这些来写一个 或 服务的java客服端。你也可以直接使用 来实现。但是..."
date: 2017-06-23
tags:
  - id: "feign"
    title: "Feign"
...
- 设置key和value都是动态的请求头
  有些API需要根据调用时动态确定使用不同的请求头(e.g. custom metadata header fields such as "x-amz-meta-_" or "x-goog-meta-_"),
