---
title: 面试复习整理
description: "**资料:** 1. Java 集合学习指南 2. Java NIO 系列教程 **常见问题:** 1. ConcurrentHashMap的实现实现原理,是如何实现高并发和同步的探索 ConcurrentHashMap高并发性的实现机制 2. 集合类中线程安全的集合有哪些(HashTable,Ve..."
date: 2017-02-20
tags:
  - id: "java"
    title: "Java"
...
1. [Java 集合学习指南](http://wiki.jikexueyuan.com/project/java-collection/)
