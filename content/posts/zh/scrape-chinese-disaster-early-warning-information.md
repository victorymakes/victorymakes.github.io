---
title: 中国灾害预警爬取解析
description: "有获取灾害信息提醒的需求，但是发现并没有开发的API 。已有的API都需要付钱。 天气预报API，可以看知乎的这边文章。网上的天气 API 哪一个更加可靠？ 里面的普通的天气预报部分免费，但是灾害预警的API都是需要收费的。于是自己去摸索了。 最后通过发F12发现了中国天气网中可用的请求: http..."
date: 2019-01-28
tags:
  - id: "spider"
    title: "Spider"
