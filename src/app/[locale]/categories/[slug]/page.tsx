...
import { getPostsByCategory, getCategories } from "@/lib/fumadocs";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const categoryTitle = posts[0].data.category.title;
  return genMetadata(locale, `/categories/${slug}`, {
    title: `${categoryTitle} - ${t("categoryPrefix")}`,
    description: `${t("categoryPrefix")} ${categoryTitle}`,
